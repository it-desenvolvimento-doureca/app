...
public class RP_OF_OP_CABDao extends GenericDaoJpaImpl<RP_OF_OP_CAB, Integer>
	...
	public List<RP_OF_OP_CAB> getid(Integer id_of_cab) {
		...
		Query query = entityManager.createQuery("Select a,b,c from RP_OF_OP_CAB a,RPOFCAB b,RP_OF_OP_FUNC c  where a.ID_OP_CAB = :id and b.ID_OF_CAB = a.ID_OF_CAB and c.ID_OP_CAB = a.ID_OP_CAB");
